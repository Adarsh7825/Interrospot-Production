...
const timeline = [
    {
        Logo: Logo1,
        heading: "Assessment",
        Description: "Custom assessments, large question bank, auto scoring.",
    },
    {
        Logo: Logo2,
        heading: "Projects",
        Description: "Industry graded projects for candidate evaluation.",
    },
    {
        Logo: Logo3,
        heading: "Outsource Interview",
        Description: "Asynchronous interviews by vetted interviewers.",
    },
    {
        Logo: Logo4,
        heading: "Pair Programming",
        Description: "Streamline panel interviews with live feedback.",
    },
];
